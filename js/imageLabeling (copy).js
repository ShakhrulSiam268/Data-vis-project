...
// function updateImageNew(bbox, thisImage) {
//     let person = thisImage.split("_")[0];

//     // Load the image
//     console.log("Update Image called for :", thisImage);
//     d3.select("#image")
//         .attr('xlink:href', "MC2-Image-Data/" + person + "/" + thisImage + ".jpg");

//     thisDifficult = null;

//     if (bbox) {
//         // Load bounding box information from the CSV
//         d3.csv("./annotated_csv/" + thisImage + ".csv", function (error, bboxData) {
//             if (error) {
//                 console.error("Error loading CSV:", error);
//                 return;
//             }

//             console.log("Bounding Box Data:", bboxData);

//             let imageDisplaySvg = d3.select(".svgImageDisplay");

//             // Remove any previous bounding box elements
//             imageDisplaySvg.selectAll(".bounding-box").remove();

//             // Draw bounding boxes
//             bboxData.forEach(function (d) {
//                 const x = +d.x;
//                 const y = +d.y;
//                 const width = +d.width;
...
//                         .attr("stroke-width", 2);
//                 } else {
//                     console.warn("Invalid bounding box data:", d);
//                 }
//             });
//         });
//     }
